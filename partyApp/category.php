...
<body>
    ...
    <div class="wrapper-planning">
        <div class="choose-layout">
            <div class="item">
                <img class="image" src="./images/category/c_1.png">
                <p class="caption">Bachelorette Party</p>
            </div>

            <div class="item">
                <img class="image" src="./images/category/c_2.png">
                <p class="caption">Wedding</p>
            </div>

            <div class="item">
                <img class="image" src="./images/category/c_3.png">
                <p class="caption">Baby Shower</p>
            </div>
            <div class="item">
                <img class="image" src="./images/category/c_4.png">
                <p class="caption">Birthday Party</p>
            </div>
            <div class="item">
                <img class="image" src="./images/category/c_5.png">
                <p class="caption">Office Party</p>
            </div>
            <div class="item">
                <img class="image" src="./images/category/c_6.png">
