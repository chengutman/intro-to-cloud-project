...
<body>
    ...
    <div class="wrapper-party-info">
        ...
        <div class = "party-info guests"></div>
        <div class = "party-info food"></div>
        <div class = "party-info drink"></div>
        <div class = "delete-btn-container">
        <button class = "btn btn-primary delete-party">- Delete Party</button>
        </div>
    </div>
